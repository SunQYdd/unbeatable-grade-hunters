...
function UserManagementPage() {
    ...
    const loadUsers = async ()=>{
        setLoading(true);
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchUsers"])(currentPage, pageSize, filterStatus, searchQuery, filterRole);
    ...
    const handleToggleUserStatus = async (userId)=>{
        ...
        if (user) {
            try {
                ...
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateUserStatus"])(userId, newStatus);
                if (response.code === 200) {
                    // 更新成功后重新加载数据
                    loadUsers();
                } else {
...
//# sourceMappingURL=_f3ff3cb7._.js.map