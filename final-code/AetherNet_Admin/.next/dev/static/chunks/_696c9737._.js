        ...
        "CategoryListPage.useEffect": ()=>{
            if (!searchQuery) {
                ...
                const filtered = categories.filter({
                    "CategoryListPage.useEffect.filtered": (category)=>category.categoryName.toLowerCase().includes(searchQuery.toLowerCase()) || category.categoryCode.toLowerCase().includes(searchQuery.toLowerCase())
                }["CategoryListPage.useEffect.filtered"]);
...
_s(CategoryListPage, "whh5k99ML4BDk4rfWsBZY1tl82k=");
_c = CategoryListPage;
var _c;
__turbopack_context__.k.register(_c, "CategoryListPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_696c9737._.js.map